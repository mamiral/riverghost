...
class GameState(BaseModel):
    ...
    def to_dict_with_relationships(self) -> Dict[str, Any]:
        ...
        result["bets"] = [bet.to_dict() for bet in self.bets]
        result["board_cards"] = self.board_cards.to_dict() if self.board_cards else None
        result["jackpots"] = [jackpot.to_dict() for jackpot in self.jackpots]
